      ...
      {isOpen && (
        <div className="fixed inset-0 z-[200] p-4 pointer-events-none">
          ...
          <motion.div 
            ...
            className="absolute top-[50%] left-[50%] pointer-events-auto w-[92%] md:w-full max-w-none md:max-w-md bg-[#0a0a0a] rounded-[20px] p-4 md:p-8 flex flex-col items-center text-center outline-none border border-primary/30 shadow-[0_0_10px_rgba(34,211,238,0.2)] max-h-[85vh] overflow-y-auto"
          >
            <h2 className="text-lg md:text-3xl font-[900] text-white mb-1 md:mb-2 tracking-tight">Get in Touch</h2>
            <p className="text-zinc-400 text-[11px] md:text-[14px] font-medium mb-4 md:mb-8 leading-relaxed">
              Choose your preferred way to start your project with WebZinc.
            </p>
            
            <div className="w-full flex flex-col gap-2 md:gap-4">
              {/* WhatsApp */}
              <div className="bg-[#050505] border border-primary/30 rounded-xl p-3 md:p-6 flex flex-col gap-2 md:gap-4 shadow-[0_0_10px_rgba(34,211,238,0.2)]">
              ...
              <div className="bg-[#050505] border border-primary/30 rounded-xl p-3 md:p-6 flex flex-col gap-2 md:gap-4 shadow-[0_0_10px_rgba(34,211,238,0.2)]">
                <div className="flex items-center justify-center gap-2 text-zinc-300">
                  <Mail size={14} className="text-primary md:size-[18px]" />
              ...
              {/* Mobile */}
              <div className="bg-[#050505] border border-primary/30 rounded-xl p-3 md:p-6 flex flex-col gap-2 md:gap-4 shadow-[0_0_10px_rgba(34,211,238,0.2)]">
                <div className="flex items-center justify-center gap-2 text-zinc-300 mb-0 md:mb-1">
                ...
                <div className="flex flex-col gap-2 md:gap-3">
                  {[
                    ...
                    <div key={item.id} className="flex flex-col sm:flex-row items-center sm:justify-between gap-2 sm:gap-0 bg-black/50 border border-white/10 rounded-lg p-2 sm:pl-4">
                      <span className="text-zinc-300 font-bold tracking-wide text-[11px] md:text-[13px] flex flex-col sm:flex-row items-center gap-1 sm:gap-0">
